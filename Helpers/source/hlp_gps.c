...
char GPS_TIME_BUF[GPS_DATA_BUFFER_HEIGHT][GPS_TIME_BUFFER_LENGHT];
char GPS_NORTH_BUF[GPS_DATA_BUFFER_HEIGHT][GPS_NORTH_BUFFER_LENGHT];
char GPS_EAST_BUF[GPS_DATA_BUFFER_HEIGHT][GPS_EAST_BUFFER_LENGHT];
char GPS_FIX_DATA_BUF[GPS_DATA_BUFFER_HEIGHT][GPS_FIX_BUFFER_LENGHT];
char GPS_VELOCITY_BUF[GPS_DATA_BUFFER_HEIGHT][GPS_VELOCITY_BUFFER_LENGHT];
char GPS_DATE_BUF[GPS_DATA_BUFFER_HEIGHT][GPS_DATE_BUFFER_LENGHT];
char GPS_ALTITUDE_DATA_BUF[GPS_DATA_BUFFER_HEIGHT][GPS_ALTITUDE_BUFFER_LENGHT];
...
void NMEA_GxGGA_RECEIVED(int bufferline)
{
	...
	GPS_TIME_BUF[0][10]='\0';
	memcpy(&GPS_NORTH_BUF[0][0],&GPS_DATA_BUF_TMP[bufline][comma[1]+1],(comma[2]-comma[1]-1));
	GPS_NORTH_BUF[0][9]='\0';
	memcpy(&GPS_EAST_BUF[0][0],&GPS_DATA_BUF_TMP[bufline][comma[3]+1],(comma[4]-comma[3]-1));
	GPS_EAST_BUF[0][10]='\0';
