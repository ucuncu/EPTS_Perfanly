...
#define GPS_NORTH_BUFFER_LENGHT  10
#define GPS_EAST_BUFFER_LENGHT  11
...
extern char GPS_NORTH_BUF[GPS_DATA_BUFFER_HEIGHT][GPS_NORTH_BUFFER_LENGHT];
extern char GPS_EAST_BUF[GPS_DATA_BUFFER_HEIGHT][GPS_EAST_BUFFER_LENGHT];
